...
SCHEMAS: dict[SchemaType, dict[str, Any]] = {
    ...
    SchemaType.FORM_DATA: {
        ...
        "properties": {
            "form_id": {"type": "string", "pattern": "^[a-zA-Z][a-zA-Z0-9_-]*$"},
    ...
    SchemaType.DOM_SELECTOR: {
        ...
        "properties": {
            ...
            "event_handler": {
                "type": "object",
                "properties": {"event": {"type": "string"}, "callback": {"type": "string"}},
            },
        },
    },
    ...
    SchemaType.MQTT_MESSAGE: {
        ...
        "properties": {
            ...
            "payload": {"oneOf": [{"type": "object"}, {"type": "string"}, {"type": "array"}]},
...
class FormDefinition(BaseModel):
    ...
    def to_dom_dsl(self) -> dict[str, Any]:
        ...
        return {
            ...
            "submit_button": {"tag": "button", "type": "submit", "text": "Submit"},
        }
        ...
        if self.operation.upper() == "SELECT":
            ...
            if self.conditions:
                ...
                for i, cond in enumerate(self.conditions):
                    param_name = f"p{i}"
                    where_parts.append(
                        f"{cond['column']} {cond.get('operator', '=')} %({param_name})s"
                    )
...
class SchemaRegistry:
    ...
    def register_schema(
        self, name: str, schema: dict[str, Any], schema_type: SchemaType | None = None
    ) -> None:
    ...
    def validate(
        self, data: dict[str, Any], schema_type: SchemaType, use_cache: bool = True
    ) -> ValidationResult:
        """
    ...
    def _semantic_validation(self, data: dict[str, Any], schema_type: SchemaType) -> list[str]:
    ...
    def validate_form_to_sql(self, form_data: dict[str, Any]) -> tuple[bool, str, dict[str, Any]]:
        ...
        try:
            ...
            operation = SQLOperation(
                operation=sql_def["operation"], table=sql_def["table"], columns=sql_def["columns"]
            )
