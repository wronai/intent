...
from intentforge.simple import generate, crud, form, query, save, Forge
...
def main():
    ...
    sql, params = query(
        "Pobierz aktywnych użytkowników posortowanych po dacie rejestracji",
        table="users"
    )
    print(f"SQL: {sql[:200]}...")
    ...
    result = (Forge("Create REST API for orders management")
        .platform("fastapi")
        .with_auth("jwt")
        .with_pagination(100)
